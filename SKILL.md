...
structure, a 53-rule offline linter, professional visual design, in-script logical
...
| `references/lint-rules.md` | Full catalog of all 53 lint rules (codes PINE001–PINE054; PINE024 unassigned) with bad/good examples |
...
script (no such public tool exists). All 53 rules are fact-checked against
