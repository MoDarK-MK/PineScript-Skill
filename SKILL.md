...
structure, a 42-rule offline linter, professional visual design, in-script logical
...
| `references/lint-rules.md` | Full catalog of all 42 lint rules (codes PINE001–PINE043; PINE024 unassigned) with bad/good examples |
...
script (no such public tool exists). All 42 rules are fact-checked against
