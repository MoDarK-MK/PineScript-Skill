...
structure, a 44-rule offline linter, professional visual design, in-script logical
...
| `references/lint-rules.md` | Full catalog of all 44 lint rules (codes PINE001–PINE045; PINE024 unassigned) with bad/good examples |
...
script (no such public tool exists). All 44 rules are fact-checked against
