...
structure, a 43-rule offline linter, professional visual design, in-script logical
...
| `references/lint-rules.md` | Full catalog of all 43 lint rules (codes PINE001–PINE044; PINE024 unassigned) with bad/good examples |
...
script (no such public tool exists). All 43 rules are fact-checked against
