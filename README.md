...
- 🔍 **48-Rule Linter** — Catches v6 compile errors, performance traps, strategy risk bugs, invisible dashboard text, and style issues *before* you paste into TradingView
...
├── scripts/
│   ├── pine_lint.py                 # 48-rule offline linter
...
│   ├── lint-rules.md                # Full catalog of 48 lint rules (PINE001–049, PINE024 unassigned)
...
| **[lint-rules.md](references/lint-rules.md)** | Full catalog of 48 lint rules (codes PINE001–PINE049; PINE024 unassigned) with examples and rationale |
...
✅ **48-Rule Linter** — Fact-checked against TradingView docs (v6 as of mid-2026)  
