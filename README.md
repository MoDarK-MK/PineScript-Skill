...
- 🔍 **44-Rule Linter** — Catches v6 compile errors, performance traps, strategy risk bugs, invisible dashboard text, and style issues *before* you paste into TradingView
...
├── scripts/
│   ├── pine_lint.py                 # 44-rule offline linter
...
│   ├── lint-rules.md                # Full catalog of 44 lint rules (PINE001–045, PINE024 unassigned)
...
| **[lint-rules.md](references/lint-rules.md)** | Full catalog of 44 lint rules (codes PINE001–PINE045; PINE024 unassigned) with examples and rationale |
...
✅ **44-Rule Linter** — Fact-checked against TradingView docs (v6 as of mid-2026)  
