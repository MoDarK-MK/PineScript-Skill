...
- 🔍 **43-Rule Linter** — Catches v6 compile errors, performance traps, strategy risk bugs, invisible dashboard text, and style issues *before* you paste into TradingView
...
├── scripts/
│   ├── pine_lint.py                 # 43-rule offline linter
...
│   ├── lint-rules.md                # Full catalog of 43 lint rules (PINE001–044, PINE024 unassigned)
...
| **[lint-rules.md](references/lint-rules.md)** | Full catalog of 43 lint rules (codes PINE001–PINE044; PINE024 unassigned) with examples and rationale |
...
✅ **43-Rule Linter** — Fact-checked against TradingView docs (v6 as of mid-2026)  
